...
namespace Gerard.Tests
{
   ...
   public class MediaInfoTests
   {
      ...
      {
         var testCandidates = Directory.GetFiles( ".//Output//DL//", "FA Cup.2015.03.09.1-4finals.Manchester United v. Arsenal.720p.mkv", SearchOption.AllDirectories ).ToList();
      ...
      {
         var testCandidates = Directory.GetFiles(".//Output//DL//", "EPL - Match of Day 720p 20.12.2014.mkv", SearchOption.AllDirectories).ToList();
